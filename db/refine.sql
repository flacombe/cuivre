...
update cuivre_adresses set 
    ...
    cuivre_voie_correct=regexp_replace(cuivre_voie, '^[^ ]+', CASE
        ...
        WHEN cuivre_voie_nature='PGE' THEN 'PASSAGE'
        ...
        WHEN cuivre_voie_nature='QU' THEN 'QUAI'
        ...
        END)
WHERE split_part(cuivre_voie,' ',1) IN ('ALL', 'AV', 'AVE', 'BD', 'BLD', 'BLVD', 'BRD', 'CHE', 'CHEM', 'CHEN', 'CL', 'CRS', 'DOM', 'ESC', 'ESP', 'FBG', 'HAM', 'IMP', 'LOT', 'MON', 'MTE', 'PAS', 'PASS', 'PCE', 'PGE', 'PL', 'PLA', 'PR', 'PROM', 'QU', 'QUA', 'R', 'RDPT', 'RES', 'RESID', 'RTE', 'SQ', 'TRA', 'VEN');
